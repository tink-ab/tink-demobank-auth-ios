...
struct TinkActivityIndicator: UIViewRepresentable {

    var isLoading: Bool

    func makeUIView(context: Context) -> ActivityIndicatorView {
        return ActivityIndicatorView()
    }

    func updateUIView(_ uiView: ActivityIndicatorView, context: Context) {
        if isLoading {
